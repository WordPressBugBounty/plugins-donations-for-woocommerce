...
[WP Zone](https://wpzone.co/) has built a whole bunch of plugins, add-ons, and themes. Check out other favorites here on the repository and don’t forget to leave a 5-star review to help others in the community decide.
...
2. Search for "Donations for WooCommerce".
3. Click "Install Now".
...
= 1.1.14 =
*Introduce new filters for customizing donation button text wpz_change_donation_button_text

= 1.1.13 =
* Remove depcreated product_type field
...
= 1.1.9 =
* Allow donations to be shipped (per customer request)

= 1.1.8 =
* Allow donation amount to be set to zero (per customer request)

= 1.1.7 =
* Add attributes support

= 1.1.6 =
* Show 'downloadable' box on the product settings page

= 1.1.5 =
* Add 'show taxes' option to the admin page and based on that setting unhide taxes options for the donations product
* Add escape functions
* Update tested up to for WooCommerce
* Other minor changes

= 1.1.4 =
* Update tested up
* Rebranding 
* Mixed minor changes on the admin page
